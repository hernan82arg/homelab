...
source "qemu" "win2019" {
  iso_url               = "/home/hernan/Win2019_server_English_x64.iso"
  ...
  qemuargs = [
    ...
    ["-drive", "file=/home/hernan/packer/output-win2019/windows2019-disk.qcow2,if=virtio,cache=writeback,discard=ignore,format=qcow2"],
    ["-boot", "order=d"]
  ]
