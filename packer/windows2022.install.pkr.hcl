...
source "qemu" "win2022" {
  iso_url               = "/home/hernan/Win2022_server_English_x64.iso"
  ...
  qemuargs = [
    ...
    ["-drive", "file=/home/hernan/Win2019_server_English_x64.iso,media=cdrom"],
    ["-drive", "file=/home/hernan/virtio-win.iso,media=cdrom"],
    ["-drive", "file=/home/hernan/packer/output-win2022/windows2022-disk.qcow2,if=virtio,cache=writeback,discard=ignore,format=qcow2"],
    ["-boot", "order=d"]
  ]
